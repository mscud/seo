...
def generate_sections(improved_outline, model="gpt-3.5-turbo", max_tokens=2000):
    ...
    for i, section_outline in enumerate(major_sections):
        ...
        prompt =  specific_section + ", please write in french language a thorough section that goes in-depth, provides detail and evidence, and adds as much additional value as possible. Keep whatever hierarchy you find. Never write a conclusion part of a section unless the section itself is supposed to be a conclusion. Section text:"
